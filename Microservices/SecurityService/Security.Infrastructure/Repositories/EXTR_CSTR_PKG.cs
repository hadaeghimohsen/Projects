...
{
    public class EXTR_CSTR_PKG : IEXTR_CSTR_SRVC
    {
        private readonly string _connectionString;

        public EXTR_CSTR_PKG(string connectionString)
        {
        ...
        private async Task<string> ExecuteFunctionAsync(string functionName, string jsonInput)
        {
            ...
            using var command = new OracleCommand($"EXTR_CSTR_PKG.{functionName}", connection)
            {
        ...
        public async Task<string> INIT_CSTR_U(string p_in)
            => await ExecuteFunctionAsync("INIT_CSTR_U", p_in);

        public async Task<string> CRET_CSTR_U(string p_in)
            => await ExecuteFunctionAsync("CRET_CSTR_U", p_in);

        public async Task<string> REMV_CSTR_U(string p_in)
            => await ExecuteFunctionAsync("REMV_CSTR_U", p_in);

        public async Task<string> ACTV_CSTR_U(string p_in)
            => await ExecuteFunctionAsync("ACTV_CSTR_U", p_in);

        public async Task<string> DACT_CSTR_U(string p_in)
            => await ExecuteFunctionAsync("DACT_CSTR_U", p_in);

        public async Task<string> GET_CSTR_U(string p_in)
            => await ExecuteFunctionAsync("GET_CSTR_U", p_in);

        public async Task<string> LIST_CSTR_U(string p_in)
            => await ExecuteFunctionAsync("LIST_CSTR_U", p_in);
    }
}
