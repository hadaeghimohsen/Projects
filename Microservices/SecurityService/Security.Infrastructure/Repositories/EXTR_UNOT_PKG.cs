...
{
    public class EXTR_UNOT_PKG : IEXTR_UNOT_SRVC
    {
        private readonly string _connectionString;

        public EXTR_UNOT_PKG(string connectionString)
        {
        ...
        private async Task<string> ExecuteFunctionAsync(string functionName, string jsonInput)
        {
            ...
            using var command = new OracleCommand($"EXTR_UNOT_PKG.{functionName}", connection)
            {
        ...
        public async Task<string> INIT_UNOT_U(string p_in)
            => await ExecuteFunctionAsync("INIT_UNOT_U", p_in);

        public async Task<string> INBX_UNOT_U(string p_in)
            => await ExecuteFunctionAsync("INBX_UNOT_U", p_in);

        public async Task<string> READ_UNOT_U(string p_in)
            => await ExecuteFunctionAsync("READ_UNOT_U", p_in);

        public async Task<string> PINT_UNOT_U(string p_in)
            => await ExecuteFunctionAsync("PINT_UNOT_U", p_in);

        public async Task<string> UPIN_UNOT_U(string p_in)
            => await ExecuteFunctionAsync("UPIN_UNOT_U", p_in);

        public async Task<string> LIST_UNOT_U(string p_in)
            => await ExecuteFunctionAsync("LIST_UNOT_U", p_in);
    }
}
