...
{
    public class EXTR_UAIN_PKG : IEXTR_UAIN_SRVC
    {
        private readonly string _connectionString;

        public EXTR_UAIN_PKG(string connectionString)
        {
        ...
        private async Task<string> ExecuteFunctionAsync(string functionName, string jsonInput)
        {
            ...
            using var command = new OracleCommand($"EXTR_UAIN_PKG.{functionName}", connection)
            {
        ...
        public async Task<string> INIT_UAIN_U(string p_in)
            => await ExecuteFunctionAsync("INIT_UAIN_U", p_in);

        public async Task<string> LIST_UAIN_U(string p_in)
            => await ExecuteFunctionAsync("LIST_UAIN_U", p_in);

        public async Task<string> COPY_UAIN_U(string p_in)
            => await ExecuteFunctionAsync("COPY_UAIN_U", p_in);
    }
}
