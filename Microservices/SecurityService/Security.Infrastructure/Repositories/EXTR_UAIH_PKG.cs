...
{
    public class EXTR_UAIH_PKG : IEXTR_UAIH_SRVC
    {
        private readonly string _connectionString;

        public EXTR_UAIH_PKG(string connectionString)
        {
        ...
        public async Task<string> INIT_UAIH_U(string p_in)
            => await ExecuteFunctionAsync("INIT_UAIH_U", p_in);

        public async Task<string> LIST_UAIH_U(string p_in)
            => await ExecuteFunctionAsync("LIST_UAIH_U", p_in);
    }
}
