...
{
    public class EXTR_UAPR_PKG : IEXTR_UAPR_SRVC
    {
        private readonly string _connectionString;

        public EXTR_UAPR_PKG(string connectionString)
        {
        ...
        private async Task<string> ExecuteFunctionAsync(string functionName, string jsonInput)
        {
            ...
            using var command = new OracleCommand($"EXTR_UAPR_PKG.{functionName}", connection)
            {
        ...
        public async Task<string> INIT_UAPR_U(string p_in)
            => await ExecuteFunctionAsync("INIT_UAPR_U", p_in);

        public async Task<string> GRNT_UAPR_U(string p_in)
            => await ExecuteFunctionAsync("GRNT_UAPR_U", p_in);

        public async Task<string> RVOK_UAPR_U(string p_in)
            => await ExecuteFunctionAsync("RVOK_UAPR_U", p_in);

        public async Task<string> CHCK_UAPR_U(string p_in)
            => await ExecuteFunctionAsync("CHCK_UAPR_U", p_in);

        public async Task<string> COPY_UAPR_U(string p_in)
            => await ExecuteFunctionAsync("COPY_UAPR_U", p_in);

        public async Task<string> LIST_UAPR_U(string p_in)
            => await ExecuteFunctionAsync("LIST_UAPR_U", p_in);
    }
}
