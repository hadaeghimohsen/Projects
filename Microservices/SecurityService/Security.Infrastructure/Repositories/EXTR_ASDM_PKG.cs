...
{
    public class EXTR_ASDM_PKG : IEXTR_ASDM_SRVC
    {
        private readonly string _connectionString;

        public EXTR_ASDM_PKG(string connectionString)
        {
        ...
        private async Task<string> ExecuteFunctionAsync(string functionName, string jsonInput)
        {
            ...
            using var command = new OracleCommand($"EXTR_ASDM_PKG.{functionName}", connection)
            {
        ...
        public async Task<string> INIT_ASDM_U(string p_in)
            => await ExecuteFunctionAsync("INIT_ASDM_U", p_in);

        public async Task<string> CRET_ASDM_U(string p_in)
            => await ExecuteFunctionAsync("CRET_ASDM_U", p_in);

        public async Task<string> REMV_ASDM_U(string p_in)
            => await ExecuteFunctionAsync("REMV_ASDM_U", p_in);

        public async Task<string> UPDT_ASDM_U(string p_in)
            => await ExecuteFunctionAsync("UPDT_ASDM_U", p_in);

        public async Task<string> LIST_ASDM_U(string p_in)
            => await ExecuteFunctionAsync("LIST_ASDM_U", p_in);
    }
}
