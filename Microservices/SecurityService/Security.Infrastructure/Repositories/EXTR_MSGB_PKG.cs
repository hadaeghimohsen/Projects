...
{
    public class EXTR_MSGB_PKG : IEXTR_MSGB_SRVC
    {
        private readonly string _connectionString;

        public EXTR_MSGB_PKG(string connectionString)
        {
        ...
        private async Task<string> ExecuteFunctionAsync(string functionName, string jsonInput)
        {
            ...
            using var command = new OracleCommand($"EXTR_MSGB_PKG.{functionName}", connection)
            {
