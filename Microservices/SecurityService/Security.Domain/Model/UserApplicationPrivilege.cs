...
{
    [Table("USER_APPLICATION_PRIVILEGE", Schema = "FCEO$KRNL")]
    public class UserApplicationPrivilege
    {
        ...
        [InverseProperty("UaprCodeNavigation")]
        public virtual ICollection<UserApplicationPrivilegeHistory>? UserApplicationPrivilegeHistories { get; set; }
    }
}
