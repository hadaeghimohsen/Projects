...
{
    [Table("ROLE_SYSTEM_REPORT", Schema = "FCEO$KRNL")]
    public class RoleSystemReport
    {
        [Key]
        [Column("CODE")]
        [MaxLength(16)]
        ...
        [ForeignKey("SysrCode")]
        public virtual SystemReport? SysrCodeNavigation { get; set; }

        [InverseProperty("RlsrCodeNavigation")]
        public virtual ICollection<RoleSystemReportHistory>? RoleSystemReportHistories { get; set; }
    }
}
