...
{
    [Table("USER_APPLICATION_ROLE", Schema = "FCEO$KRNL")]
    public class UserApplicationRole
    {
        ...
        [InverseProperty("UarlCodeNavigation")]
        public virtual ICollection<UserApplicationRoleHistory>? UserApplicationRoleHistories { get; set; }
    }
}
